...
struct ArticleModel {
    ...
    init(id: String, title: String, body: String, dateCreated: Date, pictureUrl: String?, procedureId: String?) {
        self.id = id
        self.title = title
        self.body = body
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.title, forKey: .tittle)
    ...
    init(from decoder: Decoder) throws {
        ...
        self.title = try container.decode(String.self, forKey: .tittle)
